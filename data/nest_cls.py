...
data_type = 'ACE2005' # dataset name
...
def process_2_t5_type(data_path):
    ...
    out_files = ["train_recall_0.6_cls.json", 'valid_recall_0.6_cls.json', 'test_recall_0.6_cls.json']
    ...
    for split, fn_out in zip(data_split, out_files):
        ...
        for data in split_dataset:
            ...
            item = {"text": data['sentence'], "label": label}
